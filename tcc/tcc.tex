...
Apenas 5 dos 7 estudos listaram de forma explícita os riscos enfrentados nos projetos. Deste grupo, o estudo primário que relatou o maior número de riscos foi S5, com um total de 63 riscos, tendo alta distribuição entre as diferentes classes, elementos e atributos, como é possível observar na Figura 6.
...
% TODO: Essas últimas seções ficam repetidas com o que já foi dito no Capítulo \ref{cap:proposta}, tem como evitar essa repetição? NO CAPÍTULO 4 EXPLICAR EM MENOS DETALHES
...
\begin{anexos}
    ...
    %\centering
    \includegraphics[scale=0.9,page=1,]{documents/declaracao_concordancia.pdf}
    %\includepdf[pages={1-last}]{documents/declaracao_concordancia.pdf} % Exemplo de inclusão de PDF externo
    %TODO alterar para versão final
